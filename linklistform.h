#ifndef LINKLISTFORM_H
#define LINKLISTFORM_H
...
class LinkListForm : public QWidget
{
    Q_OBJECT

public:
    explicit LinkListForm(QWidget *parent = nullptr);
    ~LinkListForm();
